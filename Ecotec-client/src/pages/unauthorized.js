...
export const Unauthorized = () => {
  return (
    <div className="flex min-w-screen min-h-screen items-center px-8 overflow-hidden bg-gradient-to-r from-blue-500 to-indigo-600 lg:p-20 dark:bg-gray-800">
      <div className="flex-1 min-h-full min-w-full p-10 bg-blue-500 text-gray-800 rounded-3xl shadow-xl items-center text-center lg:px-20 md:flex md:text-left dark:bg-gray-700">
        <div className="w-full md:w-1/2">
          <div className="mb-10 text-gray-200 md:mb-20">
            <h1 className="text-4xl font-black text-gray-100 mb-10 lg:text-5xl">
              Upss... no tienes acceso
            </h1>
            <p className="font-medium text-base text-gray-200 sm:text-base">
              Tus permisos no son suficientes para acceder a esta página.
            </p>
          </div>
        ...
        <div className="w-full text-center md:w-1/2">
          <svg
            className="dark:bg-gray-400 rounded-lg"
            id="404-Dave"
